...
const Body = () => {
  return (
    <div className="max-w-5xl mt-4 mx-auto mb-4 p-4">
      <h1 className="font-semibold text-black-0 mb-6">
        ...
        <div className="max-w-lg  md:max-w-xl">
          <div className="w-full h-52 shadow-3xl rounded-xl pt-5 md: p-3">
            <div className="flex justify-between">
              <h2 className="font-bold text-sm md:text-sm lg:text-base">
                Junior Full-Stack Engineer
              </h2>
              <p className="text-grey-3 text-xs mt-1 md:text-xm lg:text-xs ">
                5 days ago
              </p>
            </div>
            <p className="text-sm flex items-center text-blue-1 font-medium pt-2">
              <TbCurrencyNaira />
              500,000 - <TbCurrencyNaira className="ml-2" />
              700,000
            </p>
            <p className="pt-3 text-sm font-normal leading-5 md:pt-1 md:text-xm lg:pt-3 lg:text-sm">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Cupiditate consequuntur ab possimus. Ratione, totam impedit.
            </p>
            <div className="flex justify-between items-center mt-3 md:mt-1 lg:mt-3">
              <p className="bg-blue-3 rounded-xl px-2 py-1 text-blue-1 font-medium md:py-1 text-sm lg:text-base ">
                REMOTE
              </p>
          ...
          <div className="w-full h-52 shadow-3xl rounded-xl pt-5 mt-4 md: p-3">
            ...
            <p className="text-pt-2 font-normal pt-1 leading-5 text-sm md:text-xm lg:text-sm">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Cupiditate consequuntur ab possimus. Ratione, totam impedit.
            </p>
            <div className="flex justify-between items-center mt-6 md:mt-1 lg:mt-6">
              <p className="bg-orange-3 rounded-xl px-2 py-1 text-orange-1 font-medium md:py-1 text-sm lg:text-base">
                ON SITE
              </p>
              <p className="text-sm md:text-xm lg:text-sm">Lagos, Nigeria</p>
            </div>
          ...
          <div className="w-full h-52 shadow-3xl rounded-xl pt-5 mt-4 md: p-3">
            ...
            <p className="pt-3 text-sm font-normal leading-5 md:text-xm lg:text-sm">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Cupiditate consequuntur ab possimus. Ratione, totam impedit.
            </p>
            <div className="flex justify-between items-center mt-6 md:mt-1 lg:mt-6">
        ...
        <div className="col-span-2 max-w-8xl">
          <div className="grid gap-6 md:grid-cols-2 ">
            {[...Array(6)].map((_, index) => (
              <div
                key={index}
                className="shadow-3xl relative px-6 py-4 h-48 rounded-xl"
              >
                ...
                <h3 className="font-medium pt-1 text-sm md:text-base">
                  Ayomide Fatogun
                </h3>
                ...
                <div className="flex justify-between items-center gap-3">
                  <div className="mt-4 py-2 px-2.5 bg-blue-5 flex items-center justify-between rounded-md md:px-1 md:py-1 lg:py-2 lg:px-2.5">
                    ...
                    <button className="text-blue-1 text-xs pl-1 capitalize md:text-xm lg:text-xs">
                      Send email
                    </button>
                  </div>
                  <div className="mt-4 py-2 px-2.5 bg-green-1 flex items-center justify-between rounded-md md:px-1 md:py-1 lg:py-2 lg:px-2.5">
                    ...
                    <button className="text-green-2 text-xs pl-1 capitalize md:text-xm lg:text-xs">
                      Message
                    </button>
                  </div>
                </div>
