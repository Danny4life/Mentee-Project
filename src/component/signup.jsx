        ...
        <div className=" form-container h-[100vh] flex flex-col items-center justify-center text-black bg-background bg-cover bg-center">
           <div className=" px-6 my-4 h-[600px]  lg:w-[400px] sm: w-[270px] bg-white rounded-lg ">
                <div>
                    ...
                    <h3 className="welcome-msg text-center my-2">Create a new account </h3>
                    ...
                    <form className="fex flex-col items-center" action="" onSubmit={handleSubmit}>
                        ...
                        <div className="w-full relative input-container">
                            <input className=" input-container input-field w-full border border-blue-600 py-2 my-2 px-4 bg-transparent rounded-md" placeholder="" type="text" />
                        ...
                        <div className="w-full relative input-container">
                            <input className=" input-container input-field w-full border border-blue-600 py-2 my-2 px-4 bg-transparent rounded-md" placeholder="" type="tel" />
                        ...
                        <div className="w-full relative input-container">
                            <input className=" input-container input-field w-full border border-blue-600 py-2 my-2 px-4 bg-transparent rounded-md" placeholder="" type="password" />
                        ...
                        <button className="w-full my-2 pb-1 py-1 bg-blue-600 text-white rounded-lg inter-uniquifier">Login</button>
                        
                    </form>
                    <div className="text-center text-xs inter-uniquifier font-light sm:text-xs"> 
                            <span>Aready have an account?
                                <button onClick={()=>props.onFormSwitch("login")}  className="inter-uniquifier font-thin text-xs sm:text-xs text-blue-600">Sign in here</button></span></div>
                </div>
            </div> 
